...
const Introduction = () => {
  return (
    <section className='h-screen w-screen bg-[#23272F] snap-start' id='about-us'>
      <div className='container mx-auto flex py-48 md:flex-row flex-col items-center'>
        ...
        <div className='lg:max-w-lg lg:w-full md:w-1/2 w-5/6 flex justify-end'>
          <Image className='object-cover object-center' alt='hero' src={banner} />
        </div>
      </div>
    </section>
  )
